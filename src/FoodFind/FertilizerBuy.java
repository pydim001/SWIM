...
public class FertilizerBuy {

    public static int x = Shop.startX + (Shop.itemW + Shop.space);
    public static int y = Shop.startY + (Shop.itemH + Shop.space); 
    public static BUY id = BUY.Fertilizer; 
    ...
    public static void render(Graphics g, Game game) {
        ...
        if(!Boolean.parseBoolean((String) array.get(1))){
            ...
            g.drawString("Level 7", x + 65, y + 185);
